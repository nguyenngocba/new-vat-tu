...
export function renderDashboard() {
  ...
  const recentImports = state.data.transactions.filter(t => 
    t.type === 'purchase' && new Date(t.date) >= thirtyDaysAgo
  );
            ...
            ${topMaterials.length > 0 ? `
                <div style="overflow-x: auto;">
                    <table style="width: 100%;">
                        <thead><tr><th>#</th><th>Tên vật tư</th><th>Số lượng nhập</th></thead>
                        <tbody>
