...
window.showMaterialDetail = function(mid) {
    ...
    const html = `
        ...
        <div class="modal-bd" style="max-height: 70vh; overflow-y: auto;">
            ...
            <div class="tbl-wrap">
                <table style="min-width: 750px;">
                    <thead><tr><th style="text-align:left;">Thời gian</th><th style="text-align:center;">Loại</th><th style="text-align:left;">Công trình</th><th style="text-align:right;">SL</th><th style="text-align:right;">Đơn giá</th><th style="text-align:right;">Thành tiền</th><th style="text-align:left;">Ghi chú</th><th style="text-align:center;">File</th></tr></thead>
                    <tbody>
