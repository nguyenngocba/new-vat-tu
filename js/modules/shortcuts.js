export function initShortcuts() {
    document.addEventListener('keydown', (e) => {
        ...
        if (e.altKey && e.key === 's') { e.preventDefault(); if(window.switchPane) window.switchPane('settings'); }
...
function showShortcutsHelp() {
    const content = `<div class="modal-hd"><span class="modal-title">⌨️ PHÍM TẮT</span><button class="xbtn" onclick="closeModal()">✕</button></div>
        <div class="modal-bd"><table style="width:100%"><thead><tr><th>Phím</th><th>Chức năng</th></thead>
        <tbody>
            ...
            <tr><td><kbd>Alt+S</kbd></td><td>⚙️ Cài đặt</td></tr>
